    ...
    <div class="mx-auto flex flex-row">
      <ul class="mx-7 flex">
        <li class="mx-10 flex flex-col">
          <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" height="36px" viewBox="0 0 36 20"
          ...
          <nuxt-link class="border-b-4 pb-1.5 border-blue-700" to="">پرواز داخلی</nuxt-link>
        ...
        <li class="mx-10 flex flex-col">
          ...
          <nuxt-link to="">پرواز داخلی</nuxt-link>
