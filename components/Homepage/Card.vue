<template xmlns="http://www.w3.org/1999/html">
  <div class="bg-gray-100 rounded-t-2xl pt-5 w-9/12 mx-auto">
    <div class="mx-auto flex flex-row">
      <ul class="mx-auto flex">
        <li class="mx-10 flex flex-col">
          <nuxt-link class="border-b-4 pb-1.5 border-blue-700" to="">
            <svg
              viewBox="0 0 24 24"
              width="36px"
              height="36px"
            ...
            <span class="flex justify-center"> پرواز داخلی </span>
          </nuxt-link>
        </li>
        <li class="mx-10 flex flex-col">
          <nuxt-link to="">
            ...
            <span class="flex justify-center"> پرواز خارجی </span>
          </nuxt-link>
        </li>
        <li class="mx-10 flex flex-col">
          <nuxt-link to="">
            ...
            <span class="flex justify-center"> قطار</span>
          </nuxt-link>
        </li>
        <li class="mx-10 flex flex-col">
          <nuxt-link to="">
            ...
            <span class="flex justify-center"> اتوبوس</span>
          </nuxt-link>
        </li>
        <li class="mx-10 flex flex-col">
          <nuxt-link to="">
            ...
            <span class="flex justify-center"> تور</span>
          </nuxt-link>
        </li>
        <li class="mx-10 flex flex-col">
          <nuxt-link to="">
            ...
            <span class="flex justify-center"> هتل</span>
          </nuxt-link>
        </li>
        <li class="mx-10 flex flex-col">
          <nuxt-link to="">
            ...
            <span class="flex justify-center"> ویلا و اقامتگاه</span>
          </nuxt-link>
        </li>
      </ul>
    </div>
